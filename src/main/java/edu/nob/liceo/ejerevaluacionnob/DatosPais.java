...
public class DatosPais {
    public static final ObservableList<String> listapaises = FXCollections.observableArrayList(
            ...
            "Guinea", "Guinea Ecuatorial", "Guyana", "Haití", "Honduras", "Hungría", "India",
            ...
            "Sudáfrica", "Sudán", "Suecia", "Suiza", "Surinam", "Tailandia", "Tanzania", "Tayikistán",
